...
namespace blastcms.web.Handlers
{
    public class GetContentGroups
    {
        ...
        public class PagedData : IPagedData<ContentGroup>
        {
            public PagedData(IEnumerable<ContentGroup> data, long count, int page)
            {
                Data = data;
                Count = count;
                Page = page;
            ...
            public IEnumerable<ContentGroup> Data { get; }
        ...
        public class Handler : IRequestHandler<Query, PagedData>
        {
            ...
            public async Task<PagedData> Handle(Query request, CancellationToken cancellationToken)
            {
                using var session = _sessionFactory.QuerySession();
                {
                    ...
                    var articles = await session.Query<ContentGroup>()
                        .Stats(out stats)
